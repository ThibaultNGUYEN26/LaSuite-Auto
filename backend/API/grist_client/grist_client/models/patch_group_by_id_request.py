...
class PatchGroupByIdRequest(BaseModel):
    """
    PatchGroupByIdRequest
    """ # noqa: E501
    schemas: Optional[List[StrictStr]] = None
    operations: Optional[List[PatchGroupByIdRequestOperationsInner]] = Field(default=None, alias="Operations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Operations": [PatchGroupByIdRequestOperationsInner.from_dict(_item) for _item in obj["Operations"]] if obj.get("Operations") is not None else None
        })
        return _obj
