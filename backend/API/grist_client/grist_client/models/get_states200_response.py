...
class GetStates200Response(BaseModel):
    """
    GetStates200Response
    """ # noqa: E501
    states: List[GetStates200ResponseStatesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "states": [GetStates200ResponseStatesInner.from_dict(_item) for _item in obj["states"]] if obj.get("states") is not None else None
        })
        return _obj
