...
------------ | ------------- | ------------- | -------------
**snapshots** | [**List[ListSnapshots200ResponseSnapshotsInner]**](ListSnapshots200ResponseSnapshotsInner.md) |  | 
...
list_snapshots200_response_from_dict = ListSnapshots200Response.from_dict(list_snapshots200_response_dict)
```
