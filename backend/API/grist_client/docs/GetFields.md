...
**recalc_deps** | **List[int]** | An array of column identifiers (colRefs) that this column depends on, prefixed with \&quot;L\&quot; constant. If any of these columns change, the column will be recalculated. E.g.: &lt;code&gt;[\&quot;L\&quot;, 2, 3]&lt;/code&gt; | [optional] 
**col_ref** | **int** | Column reference, e.g.: &lt;code&gt;2&lt;/code&gt; | [optional] 
...
json = "{}"
# create an instance of GetFields from a JSON string
get_fields_instance = GetFields.from_json(json)
# print the JSON string representation of the object
print(GetFields.to_json())

# convert the object into a dict
get_fields_dict = get_fields_instance.to_dict()
# create an instance of GetFields from a dict
get_fields_from_dict = GetFields.from_dict(get_fields_dict)
```
