...
json = "{}"
# create an instance of CreateFields from a JSON string
create_fields_instance = CreateFields.from_json(json)
# print the JSON string representation of the object
print(CreateFields.to_json())

# convert the object into a dict
create_fields_dict = create_fields_instance.to_dict()
# create an instance of CreateFields from a dict
create_fields_from_dict = CreateFields.from_dict(create_fields_dict)
```
