...
class CreateItemRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "type", "filename", "description", "extension"]
    ...
    def extension_validate_enum(cls, value):
        ...
        if value not in set(['odt', 'ods', 'odp']):
            raise ValueError("must be one of enum values ('odt', 'ods', 'odp')")
        return value
